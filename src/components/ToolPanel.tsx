        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0">
          <div className="flex flex-col space-y-2 h-full">
            ...
            <textarea
              ...
              className="flex-1 w-full bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-200 rounded-lg p-4 border border-zinc-200 dark:border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 font-mono text-sm resize-none min-h-[200px] placeholder:text-zinc-400 dark:placeholder:text-zinc-600"
              placeholder={
          ...
          <div className="flex flex-col space-y-2 h-full">
            ...
            <div className="flex-1 w-full bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-200 rounded-lg p-4 border border-zinc-200 dark:border-white/10 font-mono text-sm overflow-auto relative group resize-none min-h-[200px] whitespace-pre-wrap">
              {error ? (
